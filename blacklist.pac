var FindProxyForURL = function(init, profiles) {
    ...
    "+\u81ea\u52a8\u5207\u6362\u6a21\u5f0f": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)inkscape\.global\.ssl\.fastly\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)bilibili\.us$/.test(host)) return "+ss";
        if (/(?:^|\.)cloud-cdn-digitalocean-com\.global\.ssl\.fastly\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)lordmi\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)google\.ca$/.test(host)) return "+ss";
        if (/(?:^|\.)stocker\.jp$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)slack-ssb-updates\.global\.ssl\.fastly\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)s3-us-west-2\.amazonaws\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)slack\.global\.ssl\.fastly\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)d78fikflryjgj\.cloudfront\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)trello\.com$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)gexperiments1\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)gexperiments2\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)ggpht\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)cesidian\.info$/.test(host)) return "+ss";
        if (/(?:^|\.)imgur\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)rockstargames\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)mobile01\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)imgtrex\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)axfc\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)humblebundle\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)riwee\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)v2ex\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)wowgirls\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)yyv\.co$/.test(host)) return "+ss";
        if (/(?:^|\.)steamworkshopdownloader\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)href\.li$/.test(host)) return "+ss";
        if (/(?:^|\.)xuite\.net$/.test(host)) return "+ss";
        if (/^85\.17\.73\.31$/.test(host)) return "+ss";
        if (/(?:^|\.)sakura\.ne\.jp$/.test(host)) return "+ss";
        if (/(?:^|\.)mega\.co\.nz$/.test(host)) return "+ss";
        if (/(?:^|\.)halfwaygully\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)tumblr\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)imgbabes\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)fezvrasta\.github\.io$/.test(host)) return "+ss";
        if (/(?:^|\.)iissnan\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)openwrt\.org$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)glasswire\.com$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)zoink\.it$/.test(host)) return "+ss";
        if (/(?:^|\.)d31qbv1cthcecs\.cloudfront\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)bahamut\.com\.tw$/.test(host)) return "+ss";
        if (/(?:^|\.)staticflickr\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)wordpress\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)yahoo\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)vanpeople\.com$/.test(host)) return "+ss";
    ...
    "+__ruleListOf_\u81ea\u52a8\u5207\u6362\u6a21\u5f0f": function(url, host, scheme) {
        ...
        if (/^http:\/\/tt-rss\.org\//.test(url)) return "+ss";
